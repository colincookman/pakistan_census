...
* **Pakistan_2017_Census_Provisional.csv**: nationwide provisional population and household counts reported at the census-block level as reported in January 2018.
* **Pakistan_2017_Census_Final.csv**: nationwide final population and household counts, with gender breakdown, at the tehsil level as reported in April 2021.
* **By district, and in national aggregate**, the following 40 detailed demographic tables as released by PBS in August 2021:
...
See the file **provisional_to_final_adm_lvl_4_comparison.csv** for author-calculated differences at the tehsil level (using January 2018 and April 2021 figures), or **provisional_final_census_comparison.csv** for differences at the lowest administrative area level above census blocks (using January 2018 and August 2021 figures).
